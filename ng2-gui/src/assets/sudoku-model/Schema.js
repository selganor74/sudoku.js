...
var RowIterator_1 = require("./RowIterator");
var ColumnIterator_1 = require("./ColumnIterator");
var BlockIterator_1 = require("./BlockIterator");
var Schema = (function () {
    function Schema() {
        this._cells = [];
    ...
    Schema.prototype.getCellAtXyPosition = function (x, y) {
        var position = CellPosition_1.CellPosition.xyToPosition({ x: x, y: y });
        return this._cells[position];
    };
    Schema.prototype.organizeCellsIntoRowsColumnsAndBlocks = function () {
        this.rowsArray = this.buildArrayFromIterator(function (index, schema) { return new RowIterator_1.RowIterator(index, schema); });
        this.columnsArray = this.buildArrayFromIterator(function (index, schema) { return new ColumnIterator_1.ColumnIterator(index, schema); });
        this.blocksArray = this.buildArrayFromIterator(function (index, schema) { return new BlockIterator_1.BlockIterator(index, schema); });
    };
    ...
    Schema.prototype.buildInitialCellSet = function () {
        for (var i = 0; i < this.NUMBER_OF_CELLS_PER_SIDE * this.NUMBER_OF_CELLS_PER_SIDE; i++) {
            this._cells.push(new Cell_1.Cell(i));
        }
    };
    Schema.prototype.getRowIterator = function (row) {
        return new RowIterator_1.RowIterator(row, this);
    };
    Schema.prototype.getColumnIterator = function (column) {
        return new ColumnIterator_1.ColumnIterator(column, this);
    };
    Schema.prototype.getBlockIterator = function (block) {
        return new BlockIterator_1.BlockIterator(block, this);
    };
